...
<?php
	...
	if($result){
		...
		$table .='<tr> <th> Name  </th> <th> Product Name/Model  </th> <th> E mail </th> <th> Contact No </th> <th> Requirement Description  </th></tr>';
		...
		while($record = mysqli_fetch_assoc($result)){
			...
			$table .='<td>' .$record['Product_code']. '</td>';
			
			$table .='<td>' .$record['Email']. '</td>';
			
			$table .='<td>' .$record['Contact_num']. '</td>';
...
<div class="dropdown">
 ...
 <a href="signup.html"><img class="transparent"src="Images/signup.png" width="50px" height="50px" align="right"></a>
	...
	<center><h1 id="h"  > Product Support Posts </h1>  </center>
