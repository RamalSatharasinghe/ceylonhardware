...
<div class="container">
  <strong><h2>Forum Account Details</h2></strong></br></br>
 
  <form class="form-inline" action="">
    <div class="form-group">
      <label for="fname">First Name</label>
      <input type="text" class="form-control" id="fname" value="<?php echo $row1['firstname'];?>" disabled>
    </div>
    <div class="form-group">
      <label for="lname">Last Name:</label>
      <input type="text" class="form-control" id="lname" value="<?php echo $row1['lastname'];?>"disabled>
    </div>
	</br></br>
	 <div class="form-group">
      <label for="district">District:</label>
      <input type="text" class="form-control" id="district" value="<?php echo $row1['district'];?>" disabled>
    </div>
