...
<?php
	...
	if($result){
		...
		$table .='<tr> <th> Post Titile </th> <th> Email </th> <th> Reply</th> </tr>';
		
		while($record = mysqli_fetch_assoc($result)){
			
			$table .='<tr>';
			
			$table .='<td>' .$record['postTitle']. '</td>';
			
			$table .='<td>' .$record['email']. '</td>';
			
			$table .='<td>' .$record['reply']. '</td>';
...
<button class="submit" >&#128269 </button>
	...
	<center><h1 id="h"  > Post Replies </h1>  </center>
	
	<center><?php echo $table; ?></center>
	
	<center> <a href="forumpostdis.php"> <input type="submit" name="submit" id="pd" value="Back">  </a></center> 
